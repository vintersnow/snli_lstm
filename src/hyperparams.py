...
parser.add_argument('--unif_init_mag', type=float, default=0.1,
                    help='magnitude for rnn random uniform inititalization')
parser.add_argument('--norm_init_std', type=float, default=1e-2,
                    help='std of norm init,'
